...
/* ---------- Hero rocket launch (rocketry-camp.html) ----------
   ...
   it flying up out of the hero section while it fades, with an
   mp3 sound effect (see launchAudio below). */
const heroRocket = document.getElementById('heroRocket');
// EDIT: swap this src for your own launch sound — see the <audio> tag
// in rocketry-camp.html, right next to the hero-rocket button.
...
function playLaunchSound() {
  ...
  try {
    ...
    launchAudio.volume = 0.5; // 0–1, adjust to taste
